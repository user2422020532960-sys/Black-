		...
		.get("/:threadID/:command", [isAuthenticated, isVeryfiUserIDFacebook, checkHasAndInThread], async (req, res) => {
			...
			switch (command) {
				case "welcome": {
					...
					variables.defaultWelcomeMessage = global.BlackBot.configCommands.envEvents.welcome.defaultWelcomeMessage;
				...
				case "leave": {
					...
					variables.defaultLeaveMessage = global.BlackBot.configCommands.envEvents.leave.defaultLeaveMessage;
