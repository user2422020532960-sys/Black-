...
(async () => {
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/saint03/Goat-Bot-V2/raw/main/${filePath}`, {
	...
	const { data: packageHTML } = await axios.get("https://github.com/saint03/Goat-Bot-V2/blob/main/package.json");
